"""Detached CPU queue for the --gate-warmup study (launch_r4_warmup.make_jobs).
...
Env: RWQ_WORKERS (default 32), RWQ_PART (default "all"), RWQ_MAX_HOURS (12).
"""
...
import launch_r4_warmup as L  # noqa: E402

ROOT = os.path.abspath(os.path.join(HERE, ".."))
LOGDIR = os.path.join(ROOT, "results", "logs")
os.makedirs(LOGDIR, exist_ok=True)
STATUS = os.path.join(LOGDIR, "r4_warmup_status.txt")

WORKERS = int(os.environ.get("RWQ_WORKERS", "32"))
PART = os.environ.get("RWQ_PART", "all")
MAX_HOURS = float(os.environ.get("RWQ_MAX_HOURS", "12"))
POLL = 30.0
